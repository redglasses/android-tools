...
libcorebase = compile(expand("core/base", corebasefiles), "-DADB_HOST=1 -Icore/base/include -Icore/include -Icore/libutils/include")
...
libzip = compile(expand("core/libziparchive", zipfiles), "-Icore/base/include -Icore/include -Icore/libziparchive/include -DZLIB_CONST -D_FILE_OFFSET_BITS=64")
...
libexpat = compile(expand("expat", libexpatfiles), "-Iexpat/lib -DHAVE_GETRANDOM -DHAVE_MEMMOVE")
...
libpng = compile(expand("libpng", libpngfiles), "-std=gnu89 -DPNG_INTEL_SSE_OPT=1")

libbuildversionfiles = %w(
  libbuildversion.cpp
)
libbuildversion = compile(expand("libbuildversion", libbuildversionfiles), "-Ilibbuildversion/include")
...
libaapt2files = %w(
  ...
  Resources.pb.cc
  Configuration.pb.cc
  ResourcesInternal.pb.cc
)
libaapt2 = compile(expand("base/tools/aapt2", libaapt2files), "-Ibase/tools/aapt2 -Icore/base/include -Icore/include -Icore/libziparchive/include -Ibase/libs/androidfw/include -Inative/include -Icore/libcutils/include -Ilibbuildversion/include")
...
aapt2 = compile(expand("base/tools/aapt2", aapt2files), "-Ibase/tools/aapt2 -Ibase/libs/androidfw/include -Icore/libutils/include -Icore/base/include -Icore/liblog/include -Icore/include -Inative/include -Icore/libziparchive/include")

link("aapt2", aapt2 + libaapt2 + libandroidfw + liblog + libcutils + libutil + libcorebase + libzip + libbuildversion + libpng + libexpat, "-L/usr/lib -lz -lprotobuf -lpthread")
