...
libbase = compile(expand("system/core/base", basefiles), "-DADB_HOST=1 -Isystem/core/base/include -Isystem/core/include")
...
liblog = compile(expand("system/core/liblog", logfiles), "-DLIBLOG_LOG_TAG=1006 -D_XOPEN_SOURCE=700 -DFAKE_LOG_DEVICE=1 -Isystem/core/include")
...
libcutils = compile(expand("system/core/libcutils", cutilsfiles), "-DPROP_NAME_MAX=32 -D_GNU_SOURCE -Isystem/core/libcutils/include -Isystem/core/include -Isystem/core/base/include")
...
libzip = compile(expand("system/core/libziparchive", zipfiles), "-std=c++17 -Isystem/core/base/include -Isystem/core/include -Isystem/core/libziparchive/include -Isystem/core/libcutils/include")
...
libutil = compile(expand("system/core/libutils", utilfiles), "-Isystem/core/include -Isystem/core/bbase/include")
...
libdex = compile(expand("dalvik/libdex", libdexfiles), "-Idalvik -Isystem/core/include -Isystem/core/libziparchive/include -Isystem/core/libcutils/include")
dexdumpfiles = %w(
  DexDump.cpp
)
dexdump = compile(expand("dalvik/dexdump", dexdumpfiles), "-Idalvik -Isystem/core/include -Isystem/core/libcutils/include")
link("dexdump", libdex + libbase + libutil + liblog + libzip + dexdump, "-lz -lsafe-iop -lnativehelper")
